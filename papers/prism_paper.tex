...
communities---which may precede the correlation spike that occurs during
an actual crisis.
Historical episodes of financial stress (e.g., 2007--2008) show a
characteristic pattern of stable surface correlations accompanied by
increasing community fragmentation in the months before the acute phase;
the duality defect is a natural candidate metric for this phenomenon,
though a rigorous retrospective study is left for future work.
...
(defect $0.43 \to 0.73$) while surface correlations remained low---a
signal invisible to correlation-based methods.
