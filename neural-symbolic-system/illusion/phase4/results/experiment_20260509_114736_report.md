...
|------|-----------|-------|--------|-------|---------------|------------|
| 1 | algebraic_restriction_p0.5 | +0.115 | 0.864 | 0.979 | False | **UNKNOWN** |
...
- **algebraic_restriction_p0.5**: UNKNOWN (low) - No matching rule in L3 knowledge base. Human review required.
...
- **algebraic_restriction_p0.3**: SAFE (high) - random algebraic restriction (p ≤ 0.3) preserves the Permanent structure but degrades circuit distinguishing power; deciding whether a circuit loses distinguishing advantage under random variable fixing requires evaluating the circuit on exponentially many restricted inputs — this is the algebraic analog of the Razborov-Smolensky method
