# Experiment Report — 2026-05-04 12:31
...
| 5 | identity | 0.889 | 0.500 | **UNKNOWN** | No matching rule in L3 knowledge base. Human review required... |
| 6 | input_negation | 0.888 | 0.499 | **UNKNOWN** | No matching rule in L3 knowledge base. Human review required... |
| 7 | random_restriction | 0.879 | 0.505 | **SAFE** | deciding whether a circuit collapses under random restrictio... |
...
- [?] identity => UNKNOWN
- [?] input_negation => UNKNOWN
- [o] random_restriction => SAFE

## Summary
- Total transforms evaluated: 10
- Candidates passed to L3: 7
- Rejected by L2: 3
- L3 SAFE: 3
- L3 UNSAFE: 2
- L3 UNKNOWN (needs human review): 2
